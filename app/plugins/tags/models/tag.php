 ...
 */
	...
	public $filterArgs = array(
		array('name' => 'name', 'type' => 'like', 'field' => 'Tag.name'),
	);
	...
	function appendFilterConditions($options, $conditions) {
		...
		if (isset($options['from'])) {
			// NOTE: see Tagged::getCloudConditions()
//			debug('apply condition to show all items tagged '.$options['from']);
		}
		if (isset($options['q'])) {
			// text search, 
			$searchKeys = array('name');	
