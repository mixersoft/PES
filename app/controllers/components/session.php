...
/**
 * CUSTOM initialize method. registers instance of SessionComponent with 
 * Session static class for using SessionComponent in Models
 *
...
/**
 * Session Static Accessor class.
 *
 * Session static class for accessing SessionComponent from Model 
 * @author Michael Lin, Snaphappi Inc., September 2010
 */
class Session {
	...
	static function instance($setInstance = null) {
		...
		if (!self::$instance) {
			throw new Exception(
				'Master class not initialized properly!'
			);
		}
		return self::$instance;
	}
	
	// callStatic does not automatically map static method names properly
	// works for ONE request, then fails. why?
	public static function __callStatic($method, $arguments) {
		// Fatal error: Call to undefined method SnappiSession::read()	
		echo "Static call to undefined function $method";
	...
	public static function read($name = null) {
        return self::$instance->read($name);
	}	
	...
	public static function check($name) {
        return self::$instance->check($name);
	}
	...
	public static function setFlash($message, $element = 'default', $params = array(), $key = 'flash') {
		return self::$instance->setFlash($message, $element, $params, $key);
	}
}
?>