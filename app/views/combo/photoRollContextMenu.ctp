<div id="contextmenu-photoroll-markup" class="menu hide yui3-aui-overlaycontext-hidden">
	<ul>
...
<div id="contextmenu-photoroll-markup-workorder" class="menu hide yui3-aui-overlaycontext-hidden">
	<ul>
		<li action='rating' class='before-show'></li>
		<li action='zoom' title='Show a 640px version of this Snap.'>Zoom In</li>
