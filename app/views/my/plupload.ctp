...
<!-- production -->
<script type="text/javascript" src="/min/b=js/plupload&amp;f=jquery.cookie.js,jquery.ba-throttle-debounce.min.js,moxie.js,plupload.js,jquery.ui.plupload/lazy_preload.js,jquery.ui.plupload/jquery.ui.plupload.js,plupload-snappi.js&123"></script>
<!--  debug -->
