<?php  
	...
	$btn_state['all-shots'] = !empty($passed['all-shots']) ? 'selected' : '';
	$btn_state['only-script-shots'] = !empty($passed['only-script-shots']) ? 'selected' : '';
...
<?php	
	...
	$this->Layout->blockStart('inner_DisplayOptions'); ?> 
	    	<ul class="filter inline">
				...
				<li class="btn white <?php echo $btn_state['all-shots']; ?>" action='shots:all-shots'>All Shots</li>
				<li class="btn white <?php echo $btn_state['only-script-shots']; ?>" action='shots:only-script-shots'>Only Script Shots</li>
