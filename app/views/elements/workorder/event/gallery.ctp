...
// init Gallery.Photo
		...
		echo $this->element('/workorder/event/section-header', compact('badge_src'));
...
?>
	<div class='gallery-container' >
		<?php 
			if ($isWide) {
				echo $this->element('/workorder/event/header-wide', compact('total', 'ownerCount', 'isPreview', 'state'));
			} else echo $this->element('/workorder/event/header', compact('total', 'ownerCount', 'isPreview', 'state'));
		?>
