    ...
    (function(){
        ...
        dojo.declare("dojox.charting.Chart2D", null, {
            constructor: function(_6, _7){
                ...
                this.margins = _7.margins ? _7.margins : {
                    l: 10,
                    t: 10,
                    r: 10,
                    b: 10
            ...
            fullGeometry: function(){
                ...
                this.plotArea = {
                    width: dim.width - _2e.l - _2e.r,
                    height: dim.height - _2e.t - _2e.b
                };
                df.forIn(this.axes, _1);
            ...
            fullRender: function(){
                ...
                if (_35) {
                    this.surface.createRect({
                        x: _33.l,
                        y: _33.t,
                        width: dim.width - _33.l - _33.r,
                        height: dim.height - _33.t - _33.b
                    }).setFill(_35);
                }
                if (_36) {
                    this.surface.createRect({
                        x: _33.l,
                        y: _33.t,
                        width: dim.width - _33.l - _33.r - 1,
                        height: dim.height - _33.t - _33.b - 1
                    }).setStroke(_36);
                }
