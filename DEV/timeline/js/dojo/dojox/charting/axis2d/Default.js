        ...
        dojo.declare("dojox.charting.axis2d.Default", dojox.charting.axis2d.Base, {
                    ...
                    if (_11) {
                        ...
                        if (o.labelFunc && o.maxLabelSize) {
                            ...
                            if (this.labels) {
                                ...
                                _12 = dojox.gfx._base._getTextBox(t.join(""), {
                                    font: _10
                                }).w;
                            }
                        }
            ...
            getOffsets: function(){
                ...
                var _15 = {
                    ...
                    t: 0,
                    b: 0
                }, _16, a, b, c, d, gl = dc.scaler.common.getNumericLabel, _17 = 0, ta = this.chart.theme.axis, _18 = "font" in o ? o.font : ta.font, _19 = "majorTick" in o ? o.majorTick : ta.majorTick, _1a = "minorTick" in o ? o.minorTick : ta.minorTick, _1b = _18 ? g.normalizedLength(g.splitFontString(_18).size) : 0, s = this.scaler;
                if (!s) {
                    return _15;
                }
