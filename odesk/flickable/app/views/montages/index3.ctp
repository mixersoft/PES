...
<script type="text/javascript"
	src="/flickable/js/pageGallery.js"> 
        </script>
<link media="screen" type="text/css"
	href="/flickable/css/horizontal.css"
	rel="stylesheet">     
</head>
...
<div id="closeBox" class="hidden"></div>
	<span id="prevPhoto"  class="hide"></span> <span id="nextPhoto"  class="hide"></span> 
	<img id="lightBoxPhoto"  class="hide"/>
</div>
