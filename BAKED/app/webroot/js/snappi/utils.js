...
(function() {
	...
	// n.getComputedStyle('visibility') != 'hidden';
	// };

	/*
	 * private
	 */
	var _isVisible = SNAPPI.util.isDOMVisible;
						...
						function(n) {
							...
							if (!n.listen['MultiSelect']) {
								n.listen['MultiSelect'] = n.delegate('click',
										SNAPPI.multiSelect.selectHandler, 'li',
										SNAPPI.multiSelect);
							}
						}, this);
