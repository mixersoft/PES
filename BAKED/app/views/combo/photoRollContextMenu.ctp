<div id="contextmenu-photoroll-markup" class="menu yui3-aui-overlaycontext-hidden">
	<ul>
		...
		<li action='zoom' title='Show a 640px version of this Snap.'>Zoom</li>
		<li action='openJpg' class='before-show' title='Open the JPG photo in another window'><a target="_blank">Open JPG</a></li>
