...
<div id="contextmenu-photoroll-markup-workorder" class="menu yui3-aui-overlaycontext-hidden">
	<ul>
		<li action='rating' class='before-show'></li>
		<li action='zoom' title='Show a 640px version of this Snap.'>Zoom In</li>
		<li action='workorder_linkTo' title='Go to the Snap home page'>Goto Snap</li>
		<div class="menu-item-group">
		<li action='showHiddenShot' class='before-show' title='Show hidden Snaps for this Shot'>Show Hidden</li>
		<li action='workorder_ungroupShot'  class='before-show' title='Remove all hidden Snaps from this Shot'>Ungroup Shot</li>			
		<li action='workorder_groupAsShot' class='before-show' title='Combinine the selected Snaps into a single Shot - only the Bestshot is visible.'>Group as Shot</li>
		</div><div class="menu-item-group">
