<div id="menu-photoPreview-actions" class="menu yui3-aui-overlaycontext-hidden">
	<ul>
		<li action='removeFromShot'  class='before-show'>Remove from Shot</li>
		<hr>
		...
		<hr>
		<li action='preview_delete' class='before-show'>Delete Snap</li>
	</ul>
</div>
