<div id="contextmenu-group-markup" class="menu yui3-aui-overlaycontext-hidden">
	<ul>
		<li action='join' class='before-show'>Join...</li>
		<li action='invite' class='disabled before-show'>Invite...</li>
