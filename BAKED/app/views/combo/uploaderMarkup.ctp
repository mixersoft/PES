...
<div class="hide"><div class="alert-import-complete container_x">
	...
	<p>We found <b>{count}</b> JPG photos in the following folder:</p>
	<div class='wrap-v'><input type='text' class='copy-paste' onclick='this.select();' value='{folder}' /></div>
	<p class='added hide'>but only <b>{added}</b> were added - the rest were duplicates.</p>
	...
	<div><ol class='wrap-v'>
		...
		<li>Click <span class='btn orange rounded-5'>Start Upload</span> to begin uploading photos.</li>
	</ol></div>
