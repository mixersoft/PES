 ...
 */
	protected $_defaults = array(
		...
		'cacheWeight' => true,
		'automaticTagging' => false,	// snappi: set to false, uses /tags/add
		'unsetInAfterFind' => false,
		'resetBinding' => false,
		'taggedCounter' => true			// snappi: set to true
	);
...
//						$tagModel->Tagged->updateAll(array('times_tagged' => 'times_tagged + 1'), array('Tagged.tag_id' => $alreadyTagged));
						$tagModel->Tagged->updateAll(array('times_tagged' => 'times_tagged + 1'), array('Tagged.tag_id' => $alreadyTagged, 'Tagged.foreign_key'=>$foreignKey));						
					}
