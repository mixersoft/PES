package com.gnstudio.nabiro.utilities.exif{
	...
	public class AddressManager{
		...
		public function AddressManager(data:ByteArray, position:int){
		...
		public function restore(offSet:int = 0):void{
			
			currentData.position = oldPosition;
			currentData.position += offSet;
